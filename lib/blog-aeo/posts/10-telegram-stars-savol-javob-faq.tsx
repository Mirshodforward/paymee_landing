...
const uzFaq = [
  ...
  { question: "Qaysi to‘lov usullari qabul qilinadi?", answer: "Click, Payme, Paynet, Uzum, UzCard, HUMO va istalgan O‘zbekiston bank kartasi — so‘mda." },
  ...
  { question: "Qaysi Premium muddati tejamkor?", answer: "12 oylik paket oyiga hisoblaganda eng arzon (388 000 so‘m)." },
...
const ruFaq = [
  ...
  { question: "Можно ли купить Premium?", answer: "Да. В StarsPaymee Premium оформляется по username — 1, 3, 6 и 12 месяцев, без входа в аккаунт." },
  ...
  { question: "Нужен ли SMS-код?", answer: "Нет. Все сроки оформляются по username; вход в аккаунт нужен только в отдельной услуге для нестандартных случаев." },
  ...
  { question: "Какие способы оплаты принимаются?", answer: "Click, Payme, Paynet, Uzum, UzCard, HUMO и любая банковская карта Узбекистана — в сумах." },
  ...
  { question: "Какой срок Premium выгоднее?", answer: "Годовой пакет дешевле всего за месяц (388 000 сум)." },
