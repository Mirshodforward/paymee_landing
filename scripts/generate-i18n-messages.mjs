...
const baseUz = {
  ...
  home: {
    ...
    giftStickerHeading: "Telegram Gift — namuna TGS animatsiyalari",
    giftStickerCaption:
      "Stikerni ustiga keltiring — animatsiya ijro etiladi va birinchi kadrda to‘xtaydi (Mini Appdagi tanlash ko‘rinishiga oʻxshash).",
...
baseRu.home = {
  ...
  giftStickerHeading: "Telegram Gift — примеры TGS-анимаций",
  giftStickerCaption:
    "Наведите курсор на стикер — анимация проиграется и остановится на первом кадре (как превью в Mini App).",
...
baseEn.home = {
  ...
  giftStickerHeading: "Telegram Gifts — sample TGS animations",
  giftStickerCaption:
    "Hover a sticker to play the loop—release to freeze on frame zero, similar to the selection preview in Mini App.",
